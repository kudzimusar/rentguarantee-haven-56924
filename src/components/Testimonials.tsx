...
const testimonials: Testimonial[] = [
  {
    id: 1,
    name: 'Venkatesh M.',
    role: 'Property Owner in Harare',
    content: "Proper Tier Properties has been managing my property and honestly, I would've lost my mind trying to handle all this myself. Coordinating appliances, finding reliable cleaning services, getting lease agreements right, managing tenant move-ins - just thinking about doing this on my own gives me a headache. Their team took over everything and I mean EVERYTHING. The guaranteed rent model is a game-changer - no tenant drama, no vacancy stress, money just lands in my account every month like clockwork. I can finally sleep peacefully knowing professionals are handling it. If you're a property owner in Harare who values your sanity, stop doing this yourself and let Proper Tier Properties handle it.",
    type: 'landlord',
    rating: 5,
  },
  {
    id: 2,
    name: 'J Ramanadhula',
    role: 'NRI Investor in Bulawayo',
    content: 'Proper Tier Properties is incredible! 2 flats in Bulawayo were rented within days of handing them over. Tenants moved in seamlessly and rental income started flowing into account while I\'ve been able to focus things that really matter. They literally handled everything - tenant sourcing and screening, lease agreements, move-in coordination, even liaising with the building society. No stress, no calls during work hours or odd times that I can\'t field, just professional service from start to finish. I honestly never thought I\'d find this level of professionalism and reliability for property management in Zimbabwe. They\'ve completely changed my experience. Highly recommend to anyone who wants hassle-free rental management!',
    type: 'landlord',
    rating: 5,
  },
  {
    id: 3,
    name: 'Kavita P.',
    role: 'Property Owner in Mutare',
    content: 'We are thoroughly impressed with Proper Tier Properties\' service! From start to finish, their team was transparent, efficient, and genuinely invested in finding me the perfect tenants. What truly stood out was their honesty - they didn\'t sugarcoat anything, and I appreciated their straightforward approach. The agents were knowledgeable, responsive, and took the time to understand my needs. Thanks to Proper Tier Properties, it was stress relief as they took the whole responsibility to find a good tenant. If you\'re looking for a reliable and trustworthy property management service, look no further than Proper Tier Properties services.',
    type: 'landlord',
    rating: 5,
  },
];
