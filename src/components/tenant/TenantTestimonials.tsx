...
const testimonials: Testimonial[] = [
  {
    id: 1,
    name: 'Tafadzwa M',
    role: 'Business Professional in Harare',
    content: "The entire team did a great job right from the first conversation till setting up my rental agreement and all questions and doubts I had with regards to my new house. I would definitely recommend Proper Tier Properties for seamless housing. Very helpful to people like me who moved from out of town",
    rating: 5,
  },
  {
    id: 2,
    name: 'Tendai R.',
    role: 'Software Engineer in Harare',
  ...
  },
  {
    id: 3,
    name: 'Simbarashe M.',
    role: 'IT Professional in Bulawayo',
    content: "After 25 hectic days of searching for a flat and finding nothing that fit my budget or needs, I came across Proper Tier Properties. These guys made the whole process so smooth—I finally got a flat within my budget, exactly matching my requirements. Couldn't be happier, highly recommend!",
    rating: 5,
  },
  {
    id: 4,
    name: 'Ruvimbo C.',
    role: 'Graduate Student in Harare',
