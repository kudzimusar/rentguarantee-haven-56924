        ...
        <main className="flex-grow pt-24 pb-16">
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg p-8 md:p-10">
              <h1 className="text-3xl md:text-4xl font-bold mb-6 theme-primary-text">Privacy Policy</h1>
              <div className="prose max-w-none text-gray-700">
                ...
                <h2 className="text-2xl font-semibold mb-4 theme-primary-text">Interpretation and Definitions</h2>
                ...
                <h2 className="text-2xl font-semibold mb-4 theme-primary-text">Collecting and Using Your Personal Data</h2>
                ...
                <h3 className="text-xl font-semibold mb-3">Information Collected while Using the Application</h3>
                <p className="mb-4">
                ...
                <h2 className="text-2xl font-semibold mb-4 theme-primary-text">Use of Your Personal Data</h2>
                ...
                <h2 className="text-2xl font-semibold mb-4 theme-primary-text">Retention of Your Personal Data</h2>
                <p className="mb-4">
                ...
                <h2 className="text-2xl font-semibold mb-4 theme-primary-text">Transfer of Your Personal Data</h2>
                <p className="mb-4">
                ...
                <h2 className="text-2xl font-semibold mb-4 theme-primary-text">Delete Your Personal Data</h2>
                <p className="mb-4">
                ...
                <h2 className="text-2xl font-semibold mb-4 theme-primary-text">Disclosure of Your Personal Data</h2>
                ...
                <h2 className="text-2xl font-semibold mb-4 theme-primary-text">Security of Your Personal Data</h2>
                <p className="mb-8">
                ...
                <h2 className="text-2xl font-semibold mb-4 theme-primary-text">Children's Privacy</h2>
                <p className="mb-4">
                  Our Service does not address anyone under the age of 18. We do not knowingly collect
                  personally identifiable information from anyone under the age of 18. If We become aware
                  that We have collected Personal Data from anyone under the age of 18 without verification
                ...
                <h2 className="text-2xl font-semibold mb-4 theme-primary-text">Links to Other Websites</h2>
                <p className="mb-4">
                ...
                <h2 className="text-2xl font-semibold mb-4 theme-primary-text">Changes to this Privacy Policy</h2>
                <p className="mb-4">
