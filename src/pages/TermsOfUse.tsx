        ...
        <main className="flex-grow pt-24 pb-16">
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg p-8 md:p-10">
              <h1 className="text-3xl md:text-4xl font-bold mb-6 theme-primary-text">Terms & Conditions</h1>
              <div className="prose max-w-none text-gray-700">
                ...
                <div className="space-y-6">
                  <p>
                    ...
                    agreement by and between LEAP TO WIN TECHNOLOGIES PRIVATE LIMITED, ( "Website Owner"
                    or "we" or "us" or "our") and you ("you" or "your") and relate to your use of our website, goods (as
